...
public class JwtService {
    ...
    public Date converter(String expiration) {
        ...
        Instant instant = dataHoraExpiracao.atZone(ZoneId.systemDefault()).toInstant(); // localdatetime to objeto
                                                                                        // instante
     ...
     * SpringApplication.run(SpringRestApiAppApplication.class);
