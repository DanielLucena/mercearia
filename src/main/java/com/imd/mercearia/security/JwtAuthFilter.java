package com.imd.mercearia.security;
    ...
    protected void doFilterInternal(
        ...
        if (authorization != null && authorization.startsWith("Bearer")) {
            ...
            if (isValid) {
                ...
                /*
                 * detalhes da autenticação para o objeto user com base nos detalhes da
                 * solicitação HTTP
                 * fornecidos pela instância de HttpServletRequest.
                 * Isso é útil para registrar informações adicionais sobre a autenticação,
                 * especialmente em um contexto de aplicativo da web - ip do cliente, agente do
                 * usário...
                 */
                 ...
                 * será considerado o usuário autenticado para a duração da solicitação ou da
                 * sessão,
